// ============================================================
// Jared Huffman Dashboard — App.jsx
...
const DATA = {
  ...
  finances: {
    totalRaised: 44145.85,
    emailDigital: 21780.02,
    smsDigital: 0.0,
    digitalTarget: 0.10,
    byMonth: [
      { month: "2025-11", total: 2039.5, digital: 1257.0 },
      { month: "2025-12", total: 7279.0, digital: 3190.0 },
      { month: "2026-01", total: 4965.5, digital: 2178.5 },
      { month: "2026-02", total: 7895.12, digital: 1981.0 },
      { month: "2026-03", total: 21124.87, digital: 12899.52 },
      { month: "2026-04", total: 841.86, digital: 274.0 }
    ],
  },
  ...
  return (
    <div style={{ fontFamily:"Arial,sans-serif", maxWidth:1100, margin:"0 auto", padding:20 }}>
      <h1 style={{ background:"#1F4E79", color:"#fff", padding:"12px 20px", borderRadius:6, marginBottom:16 }}>
        Jared Huffman — Digital Dashboard ({DATA.period})
      </h1>
