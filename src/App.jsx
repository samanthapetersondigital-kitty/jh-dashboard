...
function PasswordGate({ children }) {
  const [authed, setAuthed] = useState(() => sessionStorage.getItem("jh_auth") === "1");
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (input === PASSWORD) {
      sessionStorage.setItem("jh_auth", "1");
      setAuthed(true);
    } else {
      setError(true);
      setInput("");
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", background: "#060f1a" }}>
      <div style={{ background: "#091929", border: "1px solid #1e3a5f", borderRadius: 12, padding: "40px 48px", minWidth: 320, textAlign: "center" }}>
        <div style={{ fontSize: 22, fontWeight: 700, color: "#fff", marginBottom: 8 }}>Jared Huffman Dashboard</div>
...
const EMAIL_TOP_LINES = [
  {
    "subject": "JH_EM_FR_180DO_250227_1_1",
    "sendDate": "2/27/25",
    "period": "weekly",
    "recipients": 3432,
    "opens": 1235,
  ...
  {
    "subject": "JH_EM_EN_180DO_251114_1_1",
    "sendDate": "11/14/25",
    "period": "weekly",
    "recipients": 3898,
    "opens": 1256,
  ...
  {
    "subject": "JH_EM_FR_180DO_251205_1_1",
    "sendDate": "12/5/25",
    "period": "weekly",
    "recipients": 3870,
    "opens": 1254,
  ...
  {
    "subject": "JH_EM_EN_180DO_251224_1_1",
    "sendDate": "12/24/25",
    "period": "weekly",
    "recipients": 3217,
    "opens": 1130,
  ...
  {
    "subject": "JH_EM_FR_180DO_251231_1_1",
    "sendDate": "12/31/25",
    "period": "weekly",
    "recipients": 3050,
    "opens": 848,
  ...
  {
    "subject": "JH_EM_FR_WL_251231_2_2",
    "sendDate": "12/31/25",
    "period": "weekly",
    "recipients": 57906,
    "opens": 1676,
...
const FINANCES = [
  ...
  },
  {
    "period": "2026-02",
    "type": "month",
    "totalActBlue": 7895.12,
    "digitalRaise": 1981.0
  },
  {
    "period": "2026-03",
    "type": "month",
    "totalActBlue": 21124.87,
    "digitalRaise": 12899.52
  },
  {
    "period": "2026-04",
    "type": "month",
...
const FINANCE_QUARTERLY = {
  period: "Q2 2026",
  totalActBlue: 44145.85,
  digitalRaise: 21780.02,
  projection: 50768,
};
...
const GROWTH_CALC = [
  ...
  { metric: "Digital % of ActBlue", value: "49.3%", benchmark: "10–15%", status: "above" },
];

const DEFAULT_HIGHLIGHTS = [
  "Dashboard initialized with data through April 14, 2026",
  "Digital raise: $21,780 (49.3% of total ActBlue)",
  "Average email open rate: 23.1%",
  "Total ActBlue raised: $44,146",
];
      ...
      <div style={{ minHeight: "100vh", background: "#060f1a", color: "#e2e8f0", fontFamily: "'Inter', sans-serif" }}>
        ...
        <header style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(6,15,26,0.96)", backdropFilter: "blur(12px)", borderBottom: "1px solid #1e3a5f", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <div style={{ width: 36, height: 36, borderRadius: 8, background: "linear-gradient(135deg,#1d4ed8,#3b82f6)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15, fontWeight: 800, fontFamily: "'Sora', sans-serif", color: "#fff" }}>{"JH"}</div>
            <div>
